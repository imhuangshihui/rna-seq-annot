...
# SRR开头的数据在/data4/Longmi4_rna_seq/NCBI
# clean过后的数据在/data14/huangshihui/v2_annotation/rna_seq/clean
# zhangjihong/20180709的数据在/data1/shijunpeng/data/LongMi4/20180709/
# 后续用stringtie组装则使用--dta, 如果还需要用cufflinks则使用--dta-cufflinks
